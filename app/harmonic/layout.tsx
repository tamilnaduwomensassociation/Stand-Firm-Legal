...
import LinkPopup from "@/components/harmonic/LinkPopup";
  ...
  return (
    <>
      ...
      <div className="harmony-theme">
        ...
        {children}
        <HarmonyFooter />
        {/* Superadmin's Link tab (harmonic brand → Content overrides,
            popupLink/popupTitle/popupText) — see components/admin/
            LinkPanel.tsx. Renders nothing when no link is set. */}
        <LinkPopup />
