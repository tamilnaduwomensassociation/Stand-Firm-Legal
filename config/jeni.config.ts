...
/**
 * JENI_LIVE — the public switch for the whole /jeni site.
 *
 * false: every route under /jeni renders a single "Mothers-Corner —
 * Coming Soon" placeholder instead of the real storefront. Nothing
 * below is deleted or unrouted — JeniHome, JeniNavbar, ServiceVertical,
 * ShopSection and every vertical config still compile, still deploy to
 * Vercel, and still render the instant this is flipped back to true.
 */
export const JENI_LIVE = false;
