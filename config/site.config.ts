...
export const presidentCorner = {
  ...
  /* The President's full message — shown after the quote above. Kept
     as an array of paragraphs (rather than one block of text) so the
     page can render each with its own justified spacing instead of
     one unbroken wall of prose; the closing purpose list, the Vision
     line and the signature are each their own field for the same
     reason: every one of them is styled differently on the page. No
     Tamil translation is supplied for this message — it is the
     President's own statement, verbatim, so it renders the same in
     both languages rather than risk a paraphrase in translation. */
  messageHeading: "Message from the President",
  paragraphs: [
    "I am M. Jenifer Arokia Mary, President of Tamilnadu Women Law Association – Madras, High Court Advocate, Social Activist and Political Leader.",
    "The primary inspiration behind establishing this Association comes from the experiences I have encountered throughout my life, from my childhood to the present day, and from my deep and unwavering passion for serving people.",
    "In particular, I have always believed that women and children deserve dignity, protection, justice, opportunities and a better future. With this vision, I founded the Tamilnadu Women Law Association – Madras as a platform through which we can contribute meaningfully to the lives of women, children and society as a whole.",
    "Our Association is not merely an organisation. It is a movement for social change and a strong platform for women's empowerment, legal awareness, justice and social welfare.",
    "We aspire to create opportunities and pathways for women to understand their rights, overcome challenges, become self-reliant and lead their lives with confidence and dignity. At the same time, we are committed to supporting the welfare, safety, education and advancement of children.",
    "I am fortunate to have a dedicated team of members who stand beside me as my strength and support. We share a common vision and are united by our commitment to serving society.",
    "For me, this Association is not just an Association — it is my family.",
    "Every member of our Association is an important part of this family. Together, we strive to work with sincerity, compassion and integrity to create meaningful change in society.",
    "There are moments in life when circumstances can overwhelm a person. At such times, we want to be the helping hand that gives strength, the shoulder that provides support, and the guiding light that gives hope.",
    "Throughout my journey in public service, I have experienced the love and affection of people who fondly call me \u201cJennima.\u201d This affectionate name gives me immense happiness and makes me feel deeply connected to the people and their lives. Their trust and affection inspire me to continue my journey of service with even greater dedication.",
  ],
  purposeLead: "Our members stand united with a common purpose:",
  purposeList: ["Empower Women.", "Protect Children.", "Promote Justice.", "Create Social Change."],
  closingParagraphs: [
    "As President of the Tamilnadu Women Law Association – Madras, I assure you that we will continue to work towards building a society where every woman can live with dignity, every child can grow with safety and opportunity, and every individual can access justice and support.",
    "We will strive to become a voice for women, a protective hand for children, and a force for positive social transformation.",
    "Together, we will create a strong identity for our Association through meaningful service, compassion, courage and action.",
  ],
  visionHeading: "Our Vision",
  visionQuote: "\u201cWomen's Empowerment \u2022 Children's Progress \u2022 Social Justice \u2022 Positive Change\u201d",
  visionClose: ["This is not merely our vision.", "This is our commitment to society."],
  gratitude: "With gratitude to everyone who stands with us and supports our journey,",
  signatureLines: [
    "M. Jenifer Arokia Mary",
    "President",
    "Tamilnadu Women Law Association – Madras",
    "High Court Advocate | Social Activist | Political Leader",
  ],
};
 ...
 * ============================================================
 * Names, qualifications and designations are transcribed exactly as
 * corrected and confirmed by the association (superseding the older
 * scan at /media/team/office-bearers-reference.jpeg, which had Vice
 * President and Joint Secretary transposed). Do not paraphrase them:
...
/* ---------------- ACTIVE NUMBERS LIST ----------------
 * Replaces the old "Before You Ask" FAQ accordion on the homepage —
 * a straight list of the association's live phone lines instead of
 * a set of pre-written questions. */
export const activeNumbers = [
  { label: "Helpline", labelTa: "உதவி எண்", number: site.phones[0], note: "General enquiries & free legal aid", noteTa: "பொது விசாரணைகள் & இலவச சட்ட உதவி" },
  { label: "Office", labelTa: "அலுவலகம்", number: site.phones[1], note: "Armenian Street, Parrys, Chennai", noteTa: "ஆர்மீனியன் தெரு, பாரிஸ், சென்னை" },
  { label: "Landline", labelTa: "நிலத்தொலைபேசி", number: site.landline, note: "Office hours only", noteTa: "அலுவலக நேரத்தில் மட்டும்" },
  { label: "WhatsApp", labelTa: "வாட்ஸ்அப்", number: site.phones[0], note: "Fastest response", noteTa: "வேகமான பதில்" },
];
