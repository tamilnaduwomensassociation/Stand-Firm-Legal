...
export function HarmonyHeader() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-[80] glass !bg-obsidian/92 shadow-[0_10px_30px_rgba(124,58,237,0.12)]">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3 md:gap-4 md:px-8">
        ...
        <a
          ...
          className="glass gold-border flex items-center gap-2 rounded-full px-3 py-2 text-gold transition-all hover:bg-gold hover:text-white"
        >
          <Phone size={15} />
          <span className="hidden font-sans text-[11px] tracking-widest sm:inline">{phone1}</span>
        </a>
      </div>
      ...
      <div className="mx-auto max-w-5xl px-6 py-14">
        <div className="flex flex-col items-center text-center">
          ...
          <ul className="mt-8 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 font-sans text-sm text-ivory-dim">
            <li className="flex items-center gap-2"><MapPin size={14} className="text-gold" /> {address}</li>
            <li>
