    ...
    <section className="bg-obsidian section-pad">
      ...
      {count > 0 && !open && (
        <button
          ...
          className="fixed right-4 top-[120px] z-[86] flex items-center gap-2.5 rounded-full bg-gold px-5 py-3 font-sans text-xs uppercase tracking-widest text-black shadow-[0_16px_40px_-10px_rgba(199,110,220,0.65)] md:right-8"
        >
          <ShoppingBag size={16} />
