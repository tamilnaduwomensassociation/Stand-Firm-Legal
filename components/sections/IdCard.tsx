...
export default function IdCardSection() {
  ...
  const [data, setData] = useState<CardData>({
    ...
    email: site.email,
    emergency: "",
    /* Scanning the printed card should land a visitor on the site's
       home page, not a per-card verification page — the actual lookup
       happens through the "Verify Membership" tab there. Still an
       editable field below, in case a future print run needs a
       different landing link. */
