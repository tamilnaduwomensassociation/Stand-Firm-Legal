 ...
 */
const BODY_W = 794 - 196 - 68;      /* sheet − bearers column − padding */
const PAGE_BODY_H = 1123 - 168 - 40 - 48;   /* − masthead − footer − padding */
 ...
 * the office bearers column is for. What they drop is the addressee and
...
function LetterSheet({
  ...
  return (
    ...
    >
      {/* ---------- masthead ---------- */}
      <div style={{ background: NAVY, padding: "22px 30px 26px", display: "flex", gap: 16, alignItems: "center" }}>
        ...
        {/* Lady Justice, gold-on-navy — the same motif the association's
            own printed letterhead carries opposite the crest. Balances
            the crest's 92px width so the title block above stays
