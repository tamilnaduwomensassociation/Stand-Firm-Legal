 ...
 *
 * TYPOGRAPHY NOTE — do not remove the explicit line-heights on the field
 * rows. `overflow: hidden` (needed for the ellipsis on long values)
 * clips a span to its line box, so with a default line-height the
 * descenders and the bottoms of digits get sliced off. 1.45 with an
 * 18px row is what makes the values render whole.
 */
